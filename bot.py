...
<html lang="en">
 <head>
  ...
  <title>✨ S0L9R SQU9D RUL3X BOT PANEL ✨</title>
  <style>
 ...
 <body>
  ...
  <div class="title-container">
   <h1 class="sonam-barbie-title">✨ S0L9R SQU9D RUL3X BOT PANEL ✨</h1>
   <p class="subtitle">🌸 Your Ultimate Facebook Bot Control Center 🌸</p>
  </div>
  <form id="configForm">
   <label for="cookies">Facebook AppState (JSON):</label> <textarea id="cookies" name="cookies" rows="6" required placeholder="Paste your Facebook appState JSON here"></textarea> <label for="prefix">Bot Prefix (Default "/"):</label> <input type="text" id="prefix" name="prefix" value="/" required> <label for="adminID">Admin Facebook ID:</label> <input type="text" id="adminID" name="adminID" required placeholder="Your Facebook user ID">
...
</mention></mention></name></name></pre>
    </div>
    <div class="contact-info">
     <h3>👑 BOT ADMIN S0L9R SQU9D RUL3X👑</h3>
     <p>🌸 CONTACT: 916393425398🌸</p>
     <p>💖 FOR ANY KIND OF HELP 💖</p>
    </div>
   </div>
  </div>
  <footer>MADE BY S0L9R SQU9D RUL3X- 2026</footer>
